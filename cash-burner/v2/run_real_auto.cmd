...
REM session presets
set OPEN_MIN_RET_PCT=0.45
set OPEN_MIN_TR_VALUE=30000000
set OPEN_MIN_TICK_COUNT=8
set OPEN_MIN_IMB=0.55
set OPEN_MAX_SPREAD_PCT=0.45
set OPEN_CONFIRM_SEC=0.4
set OPEN_COOLDOWN_SEC=45

set MID_MIN_RET_PCT=0.35
set MID_MIN_TR_VALUE=25000000
set MID_MIN_TICK_COUNT=7
set MID_MIN_IMB=0.54
set MID_MAX_SPREAD_PCT=0.50
set MID_CONFIRM_SEC=0.3
set MID_COOLDOWN_SEC=40

set CLOSE_MIN_RET_PCT=0.30
set CLOSE_MIN_TR_VALUE=20000000
set CLOSE_MIN_TICK_COUNT=6
set CLOSE_MIN_IMB=0.53
set CLOSE_MAX_SPREAD_PCT=0.55
set CLOSE_CONFIRM_SEC=0.3
set CLOSE_COOLDOWN_SEC=35
